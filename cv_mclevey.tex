...
\ind John McLevey. ``What Does it Mean to be `Free?' Hacking in the Free / Open Source Field.'' \emph{In progress} \\ % For submission to \emph{Poetics}

\ind John McLevey. ``Think Tanks in the Space of Opinion: Tactics for Creating Uncertainty about the Scientific Consensus on Climate Change.'' \emph{In progress} \\ % For submission to either \emph{Science, Technology \& Human Values}

\ind Vanina Leschziner, Neil McLaughlin, John McLevey, and Allyson Stokes (Alphabetical listing). ``The American Fame Game: Academic Status and Public Renown in the Social Sciences.'' \emph{In progress} \\ % For submission to \emph{Poetics}
