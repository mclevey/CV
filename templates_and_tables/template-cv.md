...
::: {.column width="90%"}
<!-- COLUMN 2 -->
$chapters.authors$. "$chapters.title$." In $chapters.editors$ (Eds) *$chapters.book$*. $chapters.city$: $chapters.press$. $if(chapters.oa)$ **{{< ai open-access >}}** [$endif$ $if(chapters.oa)$**Open Access Link**]($chapters.oa$)$endif$<br>
:::
